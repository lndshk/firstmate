...
| `fm-error-harvest.py`    | Read Claude Code transcripts to report recurring tool errors, denials, and hook failures without executing or writing transcript content |
...
tests/fm-error-harvest.test.sh             # recurring-failure transcript harvesting: grouping, filtering, redaction, unreadable input, and report/JSON exit semantics
