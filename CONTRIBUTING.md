...
- Shell helpers in `bin/` are plain bash; the read-only `fm-error-harvest.py` is Python 3.
  Each entrypoint starts with accurate usage documentation; keep it current when you change behavior.
